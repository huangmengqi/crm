...
insert  into `t_cus_dev_plan`(`id`,`saleChanceId`,`planItem`,`planDate`,`exeAffect`) values (1,1,'测试计划项','2011-01-01','好'),(4,1,'haha','2015-05-20','en啊'),(5,1,'ss','2015-05-13',''),(6,16,'2121','2015-05-28',''),(7,16,'21121','2015-05-19',''),(8,19,'21','2015-05-28',''),(9,2,'1','2015-05-27','2'),(10,2,'2','2015-05-28',''),(11,21,'好','2015-06-09','额'),(12,22,'联系客户，介绍产品','2015-06-01','有点效果'),(13,22,'请客户吃饭，洽谈','2015-06-07','成功了');
...
insert  into `t_customer_contact`(`id`,`cusId`,`contactTime`,`address`,`overview`) values (1,1,'2015-05-14','1','2'),(2,1,'2015-05-06','1','2');
...
insert  into `t_customer_loss`(`id`,`cusNo`,`cusName`,`cusManager`,`lastOrderTime`,`confirmLossTime`,`state`,`lossreason`) values (1,'1','大风科技','小张','2015-02-01','2014-05-01',1,'11'),(3,'KH20150526073022','鸟人科技','小红','2014-02-02','2014-05-01',1,'公司迁地址'),(4,'KH20150526073023','321','小丽','2014-02-03',NULL,1,NULL);
...
insert  into `t_customer_order`(`id`,`cusId`,`orderNo`,`orderDate`,`address`,`state`) values (1,1,'DD11213','2015-02-01','11',1),(2,16,'DD11212','2014-01-02','22',1),(3,16,'DD21321','2014-02-02','22',1),(4,17,'DD2121','2014-02-03','ss',1);
...
insert  into `t_customer_reprieve`(`id`,`lossId`,`measure`) values (1,1,'打电话给客户，询问不卖我司产品原因2'),(2,1,'发送我司最新产品给客户'),(3,1,'s'),(4,4,'多发'),(5,4,'2121');
