	...
	<table style="padding: 5px" width="100%">
		<tr>
			...
			<td valign="bottom" align="right" width="50%">
				...
				<a href="javascript:openPasswordModifyDialog()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-modifyPassword'" style="width:100px;">修改密码</a>
...
<div region="south" style="height: 25px;padding: 5px;" align="center">
	版权所有 java201601班  <a href="http://dx.hnxhdn.com/" target="_blank">http://dx.hnxhdn.com/</a> (2013-2017)
</div>
